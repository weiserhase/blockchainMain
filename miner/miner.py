...
async def handleMessages():
    '''
    this Function is used to handle new Incoming Messages and establish a websocket Connection to the Pool
    args:
        ~websocket
    ...
    while True:
        try:
            ...
            for i in range(10):
                print('could no establish connection retrying in '+ str(9-i) + ' seconds', end='\r') 
                time.sleep(1)
            pass
